...
class BackfillGenerosMulti extends Command
{
    protected $signature = 'livros:backfill-generos-multi {--limit=200}';
    protected $description = 'Preenche géneros (muitos-para-muitos) com tradução PT e fallback por descrição';
            ...
            ->chunk(50, function ($chunk) {
                foreach ($chunk as $livro) {
                    try {
                        ...
                        $livro->generos()->syncWithoutDetaching($generoIds);
